...
function PureChatHeader({
  ...
  return (
    <header className="flex sticky top-0 bg-background py-1.5 items-center px-2 md:px-2 gap-2 border-b">
      ...
      {chatTitle && (
        <span className="text-sm font-semibold truncate order-0 md:order-1 mx-2" title={chatTitle}>
          {chatTitle}
        </span>
      )}
...
export const ChatHeader = memo(PureChatHeader, (prevProps: PureChatHeaderProps, nextProps: PureChatHeaderProps) => {
  return (
